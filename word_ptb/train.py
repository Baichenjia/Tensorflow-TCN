...
parser.add_argument('--dropout', type=float, default=0.45, help='dropout applied to layers')
parser.add_argument('--emb_dropout', type=float, default=0.25, help='dropout applied to layers')
parser.add_argument('--clip', type=float, default=0.35, help='gradient clip, -1 means no clip ')
parser.add_argument('--epochs', type=int, default=100, help='upper epoch limit ')
parser.add_argument('--ksize', type=int, default=3, help='kernel size ')
parser.add_argument('--emsize', type=int, default=600, help='kernel size ')
parser.add_argument('--levels', type=int, default=4, help='# of levels')
parser.add_argument('--seq_len', type=int, default=80, help='sequence length')
parser.add_argument('--validseqlen', type=int, default=40,help='valid sequence length')
